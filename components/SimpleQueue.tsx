  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-card p-4 rounded-lg">
        <h3 className="text-lg font-semibold mb-2 text-card-foreground">Queue Contents:</h3>
        <div className="flex space-x-2">
          {queue.map((item, index) => (
            <div key={index} className="bg-accent text-accent-foreground p-2 rounded border border-border">
              {item}
            </div>
          ))}
        </div>
