...
export default function CircularQueueVisualization() {
  const [queue, setQueue] = useState<(string | null)[]>(new Array(5).fill(null))
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-card p-4 rounded-lg">
        <h3 className="text-lg font-semibold mb-2 text-card-foreground">Circular Queue:</h3>
            ...
            {queue.map((item, index) => (
              <motion.div
                ...
                className={`w-16 h-16 flex items-center justify-center rounded-full border-2 m-1 ${
                  item ? "bg-primary text-primary-foreground" : "bg-accent text-accent-foreground"
