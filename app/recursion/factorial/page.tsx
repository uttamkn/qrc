  ...
  return (
    <div className="space-y-8">
      ...
      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        ...
        <p className="mb-4">
          Factorial calculation is a classic example of a problem that can be solved recursively. The recursive
        ...
        <p className="mb-4">
          This definition translates directly into a recursive function, making it an excellent introductory example for
          understanding recursion.
        </p>
      </section>

      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Interactive Factorial Calculator</h2>
      ...
      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Applications of Factorial</h2>
        <p className="mb-4">Factorial has numerous applications in mathematics and computer science:</p>
        <ul className="list-disc list-inside mb-4 pl-4">
          <li>Combinatorics: Calculating the number of ways to arrange n distinct objects</li>
          <li>Probability: Used in calculating permutations and combinations</li>
          <li>Taylor series expansions: In calculus, for expressing functions as infinite series</li>
          <li>Graph theory: In counting the number of possible spanning trees in a complete graph</li>
