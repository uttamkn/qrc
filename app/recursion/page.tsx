...
export default function RecursionPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="bg-card rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">Understanding Recursion</h3>
              <p className="text-sm text-gray-600">A comprehensive guide to recursion in programming.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Key Components of Recursion</h2>
        <ul className="list-disc list-inside mb-4 pl-4">
          <li>
            <strong>Base Case:</strong> The condition that stops the recursion
          </li>
          <li>
            <strong>Recursive Case:</strong> The part where the function calls itself
          </li>
          <li>
            <strong>Progress Towards Base Case:</strong> Each recursive call should move closer to the base case
          </li>
        </ul>
      </section>
      <hr className="my-8 border-border" />
...
function factorial(n) {
  ...
  return n * factorial(n - 1);
      ...
      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        ...
        <p className="mb-4">A function calls itself directly. The factorial example above is direct recursion.</p>

        <h3 className="text-xl font-semibold mb-2">2. Indirect Recursion</h3>
        <p className="mb-4">
          Function A calls function B, which in turn calls function A. This forms a cycle of function calls.
        </p>

        <h3 className="text-xl font-semibold mb-2">3. Tail Recursion</h3>
        <p className="mb-4">
          A recursive call is the last operation in the function. This can be optimized by some compilers.
        </p>
      </section>
      <hr className="my-8 border-border" />

      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Advantages and Disadvantages</h2>
        <h3 className="text-xl font-semibold mb-2">Advantages:</h3>
        <ul className="list-disc list-inside mb-4 pl-4">
          <li>Can lead to clean, elegant code for certain problems</li>
          <li>Naturally suited for problems with recursive structures (e.g., tree traversal)</li>
        ...
        <ul className="list-disc list-inside mb-4 pl-4">
          ...
          <li>Sometimes harder to understand and debug than iterative solutions</li>
        </ul>
      </section>
      <hr className="my-8 border-border" />

      <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Common Recursive Algorithms</h2>
        <p className="mb-4">Explore the following recursive algorithms with interactive visualizations:</p>
        <ul className="list-disc list-inside mb-4 pl-4">
          <li>
            <a href="/recursion/factorial" className="text-blue-600 hover:underline">
              Factorial
            </a>{" "}
            - Calculate the product of all positive integers up to a given number
          </li>
          <li>
            <a href="/recursion/fibonacci" className="text-blue-600 hover:underline">
              Fibonacci
            </a>{" "}
            - Generate the Fibonacci sequence where each number is the sum of the two preceding ones
          </li>
          <li>
            <a href="/recursion/tower-of-hanoi" className="text-blue-600 hover:underline">
              Tower of Hanoi
            </a>{" "}
