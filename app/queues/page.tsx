  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="space-y-8">
        ...
        <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="bg-card rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">Queue Data Structure Explained</h3>
                <p className="text-sm text-gray-600">An in-depth look at queues and their implementations.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
          <h2 className="text-2xl font-semibold mb-4">Basic Queue Operations</h2>
          <ul className="list-disc list-inside mb-4 pl-4">
            <li>
        ...
        <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
          ...
          <p className="mb-4">There are several variations of queues, each with its own use cases:</p>

          <h3 className="text-xl font-semibold mb-2">1. Simple Queue</h3>
          <p className="mb-4">
            The basic implementation of a queue. Elements are added to the rear and removed from the front.
          </p>
          ...
          <p className="mb-4">
            A queue where elements have associated priorities. Elements with higher priority are served before elements
            with lower priority.
          </p>
        </section>
        <hr className="my-8 border-border" />
        ...
        <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
          ...
          <p className="mb-4">Queues are used in various applications, including:</p>
          <ul className="list-disc list-inside mb-4 pl-4">
            <li>
              <strong>Task Scheduling:</strong> In operating systems for managing processes
            </li>
            <li>
            ...
            <li>
              <strong>Buffering:</strong> In computer networks for managing data packets
            </li>
            <li>
              <strong>Print Queue Management:</strong> In printer spoolers for managing print jobs
            </li>
            <li>
              <strong>Call Center Systems:</strong> For managing customer service calls in the order they are received
            </li>
          </ul>
        </section>
        <hr className="my-8 border-border" />
        ...
        <section className="mb-8 p-6 bg-card rounded-lg border border-border shadow-sm">
          ...
          <ul className="list-disc list-inside mb-4 pl-4">
            <li>
              <a href="/queues/simple" className="text-blue-600 hover:underline">
                Simple Queue
              </a>
            </li>
            <li>
